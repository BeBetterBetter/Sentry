...
/**
  * @brief  CAN1总线数据发送函数
  * @param  
- uint32_t Equipment_ID:CAN总线单位标识符
- int16_t Data0:ID1的单位数据
- int16_t Data1:ID2的单位数据
- int16_t Data2:ID3的单位数据
- int16_t Data3:ID4的单位数据

- 这里使用的是CAN的集线器连接数个can单元,\
- 组成区域网络,因此向此网络内的数据发送整\
- 包数据即可发送至各个单元中.详细查阅电机手册.
  * @return void
  * @attention 
*/
